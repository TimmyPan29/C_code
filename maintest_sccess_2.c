...
// //開檔
 ...
 // //讀檔
	...
	// int **tm;
	// tm = (int**)malloc(b*sizeof(int*));  // 二維矩陣
	// for(i=0;i<b;i++)
	// {
		// tm[i]=(int*)malloc((a-b)*sizeof(int));
	// }
...
/*initial setting*/	
	...
	fscanf(ff,"%d",&a);
	fscanf(ff,"%d",&b);
	// h1 = malloc(sizeof(int*)*b); //for original matrix 這一段其實不用打
	// for (int i=0;i<b;i++){
		// h1[i] = malloc(sizeof(int)*a);
	// }
	// for (int i=0;i<b;i++){
